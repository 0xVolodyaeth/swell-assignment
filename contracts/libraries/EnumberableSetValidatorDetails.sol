...
library EnumberableSetValidatorDetails {
    ...
    function range(
        ...
        view
        returns (
            INodeOperatorRegistry.ValidatorDetails[] memory validatorDetails
        )
    {
    ...
    function removePendingDetails(
        ...
        if (pubKeyIndex != 0) {
            ...
            if (lastIndex != toDeleteIndex) {
                INodeOperatorRegistry.ValidatorDetails memory lastValue = set
                    ._values[lastIndex];
    ...
    function removeActiveDetails(
        ...
        if (pubKeyIndex != 0 && operatorActiveValidators != 0) {
            ...
            if (toDeleteIndex != lastActiveValidatorIndex) {
                INodeOperatorRegistry.ValidatorDetails memory lastValue = set
                    ._values[lastActiveValidatorIndex];
